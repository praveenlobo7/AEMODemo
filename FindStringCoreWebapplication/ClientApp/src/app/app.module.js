...
var find_subtext_component_1 = require("./find-subtext/find-subtext.component");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                find_subtext_component_1.FindSubtextComponent
            ],
            imports: [
                ...
                router_1.RouterModule.forRoot([
                    { path: '', component: find_subtext_component_1.FindSubtextComponent, pathMatch: 'full' },
